...
transformed = fred_msa.transform_data(normalized, id_vars, monthly_cols, seasonal_cols, annual_cols, monthly_order, seasonal_order, annual_order)
transformed.to_csv('..\\cleaned-data\\data-var-format.csv', index=False)